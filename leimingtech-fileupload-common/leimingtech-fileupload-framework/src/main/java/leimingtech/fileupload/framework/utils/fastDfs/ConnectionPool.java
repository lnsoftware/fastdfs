package leimingtech.fileupload.framework.utils.fastDfs;
...
/**
 * FastDFS连接池
 * 根据fast_client中的配置设置连接TrackerServer的数量
 */
public class ConnectionPool {
    ...
    private void poolInit(String logId) {
        try {
            ...
            LOGGER.error("[FASTDFS初始化(init)--异常][" + logId + "][异常 ：" + e1 + "]");
        }
    }


    /**
     * 创建TrakerServer并放入连接池
     *
     * @param logId
     * @param flag
     */
    ...
    /**
     * @param trackerServer
     * @Description: 删除不可用的连接，并把当前连接数减一
     */
